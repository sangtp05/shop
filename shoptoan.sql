...
-- Thời gian đã tạo: Th10 31, 2024 lúc 01:52 AM
...
CREATE TABLE `danhmuc` (
  `madm` int NOT NULL,
  `tendm` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `hoadon` (
  ...
  `trangthai` set('gio-hang','chuan-bi-don-hang','dang-giao-hang','da-giao') COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `sanpham` (
  ...
  `anh` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `taikhoan` (
  ...
  `anh` varchar(500) COLLATE utf8mb4_general_ci NOT NULL,
  `quyen` varchar(50) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'user',
